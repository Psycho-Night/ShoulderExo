...
// AAN controller - Maxon Current controller v1.0

// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

//--------------------- AAN ------------------------------------------------------------

const float alpha = 0.1;  // Keep it 0.1
const float beta = 0.05;  // Keep it 0.05


// Tune those and keep changes
const float a = 20;      // 0.2
const float b = 0.05;      // 5.0
...
const float phaseShift = -0/2;          // Phase shift for graduate raise from 0 deg -PI/2 if sin wave and 0 if step
