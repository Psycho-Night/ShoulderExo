...
// Maxon Motor - Torque Open Loop v1.0 - Wrote Teensy 4.1
...
void loop() {
  ...
  float DesiredTorque = targetTourque;

  desiredCurrent = (abs(DesiredTorque)/gearRatio) / Kt; // Convertion from Torque to Current [A]
