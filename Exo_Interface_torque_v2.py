...
class SimplePlotter(QMainWindow):
    ...
    def setup_plots(self):
        ...
        # --- Plot 5: Frequency ---
        self.plot4 = self.graphWidget.addPlot(4, 0, title="Sampling Frequency")
    ...
    def save_data(self):
        ...
        header = "Time(s), Target Angle, Current Angle, T_FF, T_FB, Torque, Target Current, Actual Current, Frequency"
